  ...
  return (
    <div className="flex flex-col bg-slate-100">
      <div className="px-2 sm:pl-14 py-3 border border-black">
        <Image src={assets.logo} width={120} alt="This is a logo" />
      </div>
      <div className="w-28 sm:w-80 h-[100vh] relative py-12 border border-black">
        <div className="w-[50%] sm:w-[80%] absolute right-0">
          ...
          >
            <Image src={assets.add_icon} width={28} alt="This is a add Icon" />
            <p>Add Blogs</p>
          </Link>
          <Link
            href="/admin/blogList"
          ...
          >
            <Image src={assets.blog_icon} width={28} alt="This is a add Icon" />
            <p>Blog List</p>
          </Link>{" "}
          <Link
